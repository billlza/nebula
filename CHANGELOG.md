...
- Contract suite baseline at the v1.0.0 tag: `487/487` (matches `docs/rc_checklist_v1.0.md`
  and `RELEASE_NOTES_v1.0.0.md`). The baseline figure is generated by
  `scripts/contract_baseline.sh`, never hand-edited.
